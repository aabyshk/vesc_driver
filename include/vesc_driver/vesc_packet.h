...
class VescPacketRotorPos : public VescPacket
{
public:
  VescPacketRotorPos(boost::shared_ptr<VescFrame> raw);

  double rotor_pos() const;

};

class VescPacketRequestRotorPos : public VescPacket
{
public:
  VescPacketRequestRotorPos();
};
...
{
public:
  VescPacketSetDetect(disp_pos_mode mode);
};
